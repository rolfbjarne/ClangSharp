...
CLANGSHARP_LINKAGE double clangsharp_Cursor_getFloatingLiteralValueAsDouble(CXCursor C);

CLANGSHARP_LINKAGE double clangsharp_Cursor_getFloatingLiteralValueAsFloat(CXCursor C);
...
CLANGSHARP_LINKAGE unsigned clangsharp_Cursor_getIsPOD(CXCursor C);
...
CLANGSHARP_LINKAGE clang::ObjCMethodFamily clangsharp_Cursor_getMethodFamily(CXCursor C);
...
CLANGSHARP_LINKAGE char * clangsharp_Cursor_getSelector(CXCursor C);
...
CLANGSHARP_LINKAGE clang::ObjCTypeParamVariance clangsharp_Cursor_getTypeParamVariance(CXCursor C);
...
CLANGSHARP_LINKAGE char * clangsharp_Cursor_prettyPrintAttribute(CXCursor C);
