...
public unsafe partial struct CXCursor : IEquatable<CXCursor>
{
    ...
    public readonly string AttrKindSpelling
    {
        get
        {
            ...
            return AttrKind switch {
                ...
                CX_AttrKind_OpenCLKernel => "OpenCLKernel",
                ...
                CX_AttrKind_SharedTrylockFunction => "SharedTrylockFunction",
    ...
    public string? GetAvailabilityAttributePlatformIdentifierName ()
    {
        var ptr = clangsharp.clangsharp_Cursor_getAvailabilityAttributePlatformIdentifierName(this);
        var str = Marshal.PtrToStringAuto(ptr);
        Marshal.FreeHGlobal(ptr);
        return str;
    }

    public VersionTuple? AvailabilityAttributeIntroduced {
        get {
            VersionTuple rv = default;
            unsafe {
                if (clangsharp.clangsharp_Cursor_getAvailabilityAttributeIntroduced(this, &rv) == 1) {
                     return rv;
                }
             }
            return null;
    ...
    public readonly string ObjCRuntimeNameAttrMetadataName {
        get {
            var ptr = clangsharp.Cursor_getObjCRuntimeNameAttrMetadataName(this);
            var str = Marshal.PtrToStringAuto(ptr);
            Marshal.FreeHGlobal(ptr);
            return str ?? "";
        }
    ...
    public readonly ObjCPropertyAttributeKind GetPropertyAttributes() => clangsharp.Cursor_getPropertyAttributes(this);
