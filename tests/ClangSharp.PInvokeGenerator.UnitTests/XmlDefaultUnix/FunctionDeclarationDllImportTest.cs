...
[Platform("unix")]
public sealed class XmlDefaultUnix_FunctionDeclarationDllImportTest : FunctionDeclarationDllImportTest
{
...
";
        ...
        return ValidateGeneratedXmlDefaultUnixBindingsAsync(inputContents, expectedOutputContents, libraryPath: string.Empty);
    }
...
";
        ...
        return ValidateGeneratedXmlDefaultUnixBindingsAsync(inputContents, expectedOutputContents, libraryPath: string.Empty, withLibraryPaths: withLibraryPaths);
    }
...
";
        ...
        return ValidateGeneratedXmlDefaultUnixBindingsAsync(inputContents, expectedOutputContents, withCallConvs: withCallConvs);
    }
...
";
        ...
        return ValidateGeneratedXmlDefaultUnixBindingsAsync(inputContents, expectedOutputContents, withSetLastErrors: withSetLastErrors);
    }
