...
[Platform("win")]
public sealed class XmlDefaultWindows_FunctionDeclarationDllImportTest : FunctionDeclarationDllImportTest
{
...
";
        ...
        return ValidateGeneratedXmlDefaultWindowsBindingsAsync(inputContents, expectedOutputContents, excludedNames: TemplateTestExcludedNames);
    }
...
";
        ...
        return ValidateGeneratedXmlDefaultWindowsBindingsAsync(inputContents, expectedOutputContents, libraryPath: string.Empty);
    }
...
";
        ...
        return ValidateGeneratedXmlDefaultWindowsBindingsAsync(inputContents, expectedOutputContents, libraryPath: string.Empty, withLibraryPaths: withLibraryPaths);
    }
...
";
        ...
        return ValidateGeneratedXmlDefaultWindowsBindingsAsync(inputContents, expectedOutputContents, withCallConvs: withCallConvs);
    }
...
";
        ...
        return ValidateGeneratedXmlDefaultWindowsBindingsAsync(inputContents, expectedOutputContents, withSetLastErrors: withSetLastErrors);
    }
