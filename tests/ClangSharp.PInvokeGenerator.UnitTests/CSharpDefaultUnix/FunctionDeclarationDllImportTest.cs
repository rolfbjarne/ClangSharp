...
[Platform("unix")]
public sealed class CSharpDefaultUnix_FunctionDeclarationDllImportTest : FunctionDeclarationDllImportTest
{
...
";
        ...
        return ValidateGeneratedCSharpDefaultUnixBindingsAsync(inputContents, expectedOutputContents, excludedNames: TemplateTestExcludedNames);
    }
...
";
        ...
        return ValidateGeneratedCSharpDefaultUnixBindingsAsync(inputContents, expectedOutputContents, libraryPath: string.Empty);
    }
...
";
        ...
        return ValidateGeneratedCSharpDefaultUnixBindingsAsync(inputContents, expectedOutputContents, libraryPath: string.Empty, withLibraryPaths: withLibraryPaths);
    }
...
";
        ...
        return ValidateGeneratedCSharpDefaultUnixBindingsAsync(inputContents, expectedOutputContents, withCallConvs: withCallConvs);
    }
...
";
        ...
        return ValidateGeneratedCSharpDefaultUnixBindingsAsync(inputContents, expectedOutputContents, withSetLastErrors: withSetLastErrors);
    }
